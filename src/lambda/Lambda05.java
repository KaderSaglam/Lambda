...
public class Lambda05 {
    ...
    public static int topla1(int x) {
        ...
        return IntStream.range(1, x + 1).//1 2 3 ... x elemanarinin akisi --> 1 dahil x+1 haric
                sum();
    }
    ...
    public static int toplaCift(int x) {
        ...
        return IntStream.rangeClosed(1, x).//1 2 3 ... x elemanarinin akisi
                //filter(Lambda01::ciftBul).//2 4 6 ... elaman akisi
                        filter(t -> t % 2 == 0).//2 4 6 ... elaman akisi
                        sum();
    }
    ...
    public static int toplaIlkCift(int x) {
        ...
        return IntStream.iterate(2, t -> t + 2).//2 4 6 ... x elemanarinin akisi
                limit(x).//akisdaki ilk x elamani verir
                sum();////akisdaki ilk x elamani toplar
    }
    ...
    public static int toplaIlkTek(int x) {
        ...
        return IntStream.iterate(1, t -> t + 2).//1 3 5 ... x elemanarinin akisı
                limit(x).//akisdaki ilk x elamanı verir
                sum();//akisdaki ilk x elamanı toplar
    }
    ...
    public static int istenenSayiniFaktoriyeli(int x) {
        ...
        return IntStream.rangeClosed(1, x).//a a^2 a^3 a^4... x elemanarinin akisi
    ...
    public static int istenenSayiniXincikuvvet(int a, int x) {
        ...
        return IntStream.iterate(a, t -> t * a).//a a^2 a^3 a^4... x elemanarinin akisi
                limit(x).//akisdaki ilk x elamani verir
                reduce(0, (t, u) -> u);
        //skip(x-1);//skip den sonra cikan elemanlari toList ile yazdirilmali
    }
